    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-resort-500">Monitor competitors, track trends, and gather brand insights</p>
        </div>
      ...
      <Tabs defaultValue="competitors">
        ...
        <TabsContent value="trends">
          <Card className="p-6">
            <div className="space-y-1 mb-6">
              <h2 className="text-xl font-medium text-resort-800">Brand Trends & Predictions</h2>
              <p className="text-sm text-resort-500">Discover emerging trends and AI-powered brand predictions</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-4">
                <h3 className="text-sm font-medium text-resort-800 mb-3">AI Brand Predictions</h3>
                <div className="space-y-3">
                  {[

...
import { mockCampaigns } from '../campaigns/mockCampaignsData';
...
const generateMockPosts = (): Post[] => {
  ...
  // Add specific posts for campaigns
  generateCampaignSpecificPosts(posts, idCounter);
  
  return posts;
};

// Generate posts specific to campaigns
const generateCampaignSpecificPosts = (posts: Post[], startId: number): void => {
